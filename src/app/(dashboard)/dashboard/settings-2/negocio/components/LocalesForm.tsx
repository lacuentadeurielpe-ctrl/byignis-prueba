                ...
                <AnimatePresence>
                  {locales.map(local => (
                    <motion.div
                      ...
                      exit={{ opacity: 0, y: -10 }}
                      className="p-4 border border-zinc-200 rounded-xl hover:border-indigo-300 hover:shadow-sm transition-all group relative"
                    >
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-2 mb-1">
                            <h3 className="text-sm font-semibold text-zinc-900">{local.nombre}</h3>
                            {local.es_principal && (
                            ...
                            {!local.activo && (
                              <span className="inline-flex items-center gap-1 px-2 py-0.5 bg-zinc-100 text-zinc-600 text-xs font-medium rounded">
                                Inactivo
                              </span>
                            )}
                          </div>

                          <p className="text-sm text-zinc-600 truncate mb-2">{local.direccion}</p>
                          ...
                          {local.codigo && (
                            <p className="text-xs text-zinc-400 mt-2">Código: {local.codigo}</p>
                          )}
                        </div>
                        ...
                        <div className="relative">
                          <button
                            ...
                            className="p-2 opacity-0 group-hover:opacity-100 hover:bg-zinc-100 rounded-lg transition-all"
                          >

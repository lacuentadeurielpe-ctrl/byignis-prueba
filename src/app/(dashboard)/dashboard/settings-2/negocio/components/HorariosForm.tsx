...
export default function HorariosForm() {
  ...
  return (
    <FormSection
      title="Horarios & AtenciÃ³n"
      description="Configura cuÃ¡ndo atiende tu tienda"
    ...
    >
      ...
      <div className="space-y-4">
        <div>
          <label className="block text-sm font-medium text-zinc-700 mb-3">DÃ­as de atenciÃ³n</label>
        ...
        <div>
          ...
          <textarea
            ...
            rows={2}
            placeholder="Ej: Hola, bienvenido a nuestro catÃ¡logo..."
          />
        </div>
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full px-3 py-2 border border-zinc-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 resize-none"
            rows={2}
            placeholder="Ej: Estamos cerrados, abrimos maÃ±ana a las 8am..."
          />
        </div>
      </div>
    </FormSection>
